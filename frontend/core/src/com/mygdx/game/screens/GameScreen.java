...
public class GameScreen extends ScreenAdapter {
 ...
 public void show(){
  ...
  SequenceAction sa2 = card2.cardAnimation(2.0f,1900, 1100 - (cWidth*2) + (cWidth*1/5), 90, 0.5f, frontImage);
  card2.addAction(sa2);

  Card card3 = new Card(backImage);
  card3.setPosition(900, 900);
  stage.addActor(card3);
  SequenceAction sa3 = card3.cardAnimation(4.0f,1900, 1100 - (cWidth*2) + (cWidth*2/5), 90, 0.5f, frontImage);
  card3.addAction(sa3);

  Card card4 = new Card(backImage);
  card4.setPosition(900, 900);
  stage.addActor(card4);
  SequenceAction sa4 = card4.cardAnimation(6.0f,1900, 1100 - (cWidth*2) + (cWidth*3/5), 90, 0.5f, frontImage);
  card4.addAction(sa4);

  Card card5 = new Card(backImage);
  card5.setPosition(900, 900);
  stage.addActor(card5);
  SequenceAction sa5 = card5.cardAnimation(8.0f,1900, 1100 - (cWidth*2) + (cWidth*4/5) , 90, 0.5f, frontImage);
  card5.addAction(sa5);

  Card card6 = new Card(backImage);
  card6.setPosition(900, 900);
  stage.addActor(card6);
  SequenceAction sa6 = card6.cardAnimation(10.0f,1900, 1100 - (cWidth*2) + (cWidth*5/5)  , 90, 0.5f, frontImage);
  card6.addAction(sa6);
  ...
  SequenceAction sa2P2 = card2P2.cardAnimation(14.0f,1900, 1100 - (cWidth*5) + (cWidth*1/5), 90, 0.5f, frontImage);
  card2P2.addAction(sa2P2);

  Card card3P2 = new Card(backImage);
  card3P2.setPosition(900, 900);
  stage.addActor(card3P2);
  SequenceAction sa3P2 = card3P2.cardAnimation(16.0f,1900, 1100 - (cWidth*5) + (cWidth*2/5), 90, 0.5f, frontImage);
  card3P2.addAction(sa3P2);

  Card card4P2 = new Card(backImage);
  card4P2.setPosition(900, 900);
  stage.addActor(card4P2);
  SequenceAction sa4P2 = card4P2.cardAnimation(18.0f,1900, 1100 - (cWidth*5) + (cWidth*3/5), 90, 0.5f, frontImage);
  card4P2.addAction(sa4P2);

  Card card5P2 = new Card(backImage);
  card5P2.setPosition(900, 900);
  stage.addActor(card5P2);
  SequenceAction sa5P2 = card5P2.cardAnimation(20.0f,1900, 1100 - (cWidth*5) + (cWidth*4/5) , 90, 0.5f, frontImage);
  card5P2.addAction(sa5P2);

  Card card6P2 = new Card(backImage);
  card6P2.setPosition(900, 900);
  stage.addActor(card6P2);
  SequenceAction sa6P2 = card6P2.cardAnimation(22.0f,1900, 1100 - (cWidth*5) + (cWidth*5/5)  , 90, 0.5f, frontImage);
